...
import com.jpdravila.cursomc.domain.enums.Perfil;
...
import com.jpdravila.cursomc.domain.Pagamento;
import com.jpdravila.cursomc.domain.PagamentoComBoleto;
import com.jpdravila.cursomc.domain.PagamentoComCartao;
import com.jpdravila.cursomc.domain.Pedido;
import com.jpdravila.cursomc.domain.Produto;
import com.jpdravila.cursomc.repositories.CategoriaRepository;
import com.jpdravila.cursomc.repositories.CidadeRepository;
...
import com.jpdravila.cursomc.repositories.ProdutoRepository;
...
public class DBService {
    ...
    public void instantiateTestDatabase() throws ParseException {
        ...
        Cliente cli1 = new Cliente(null, "Maria Silva", "jpdravila@hotmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
        cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

        Cliente cli2 = new Cliente(null, "Ana Costa", "jpdravila@gmail.com", "96378584400", TipoCliente.PESSOAFISICA, pe.encode("123"));
        cli2.getTelefones().addAll(Arrays.asList("27363289", "938065449"));
        cli2.addPerfil(Perfil.ADMIN);

        Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
        Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
        Endereco e3 = new Endereco(null, "Avenida Florian", "2106", null, "Centro", "06777012", cli2, c2);
